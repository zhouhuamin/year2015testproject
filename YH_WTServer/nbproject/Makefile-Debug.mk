...
${OBJECTDIR}/ProcessWeight.o: ProcessWeight.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../jiezisoft/tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessWeight.o ProcessWeight.cpp
...
${OBJECTDIR}/weight.o: weight.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../jiezisoft/tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/weight.o weight.cpp
