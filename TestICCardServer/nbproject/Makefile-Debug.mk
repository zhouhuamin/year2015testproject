...
${OBJECTDIR}/RFID_label.o: RFID_label.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../jiezisoft/tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RFID_label.o RFID_label.cpp
...
${OBJECTDIR}/ic_card.o: ic_card.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../jiezisoft/tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ic_card.o ic_card.cpp

${OBJECTDIR}/ic_card_phy.o: ic_card_phy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../jiezisoft/tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ic_card_phy.o ic_card_phy.cpp
